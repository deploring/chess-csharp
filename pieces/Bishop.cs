...
/// This piece can move diagonally in all four directions over an unlimited amount of tiles.
/// </summary>
/// <param name="color">The color of this bishop.</param>
class Bishop(Constants.Color color) : Piece(color, Constants.PieceType.Bishop)
{
    /// <summary>
    /// The diagonal directions a bishop can move in.
    /// </summary>
    ...
    /// <summary>
    /// Determines all possible moves this Bishop can make at the given coordinates in a given board state.
    /// </summary>
    /// <param name="board">The current Board state.</param>
    /// <param name="originRow">The row where this Bishop is located.</param>
    /// <param name="originColumn">The column where this Bishop is located.</param>
    /// <returns>All possible moves this Bishop can make.</returns>
    /// <see cref="Board"/>
